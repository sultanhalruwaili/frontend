...
export default class Service2 extends Component {
    ...
    render() {
        const MyLawyers = this.state.Lawyers.filter(item => item.service == 'Arbitration');
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="details">
                                            ...
                                            {this.setState.login == "authenticatedADMIN" &&
                                                <button type="button" class="btn btn-outline-m" onClick={(e) => this.deleteLawyer(item.lawyer_Id, e)}>
